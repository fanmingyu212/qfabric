### FROM SPECTRUM INSTRUMENTS PYTHON EXAMPLES.
...
from qfabric.programmer.driver.m4i6622.py_header.regs import *

# load registers for easier access
from qfabric.programmer.driver.m4i6622.py_header.spcerr import *
